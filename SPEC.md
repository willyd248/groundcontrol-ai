...
`Box(low=-1, high=1, shape=(266,), dtype=float32)`
...
| [161..184] | 6 vehicle slots × 4 features | state_norm, pos_idx_norm, type_norm, is_free |
| [185..264] | 16 task slots × 5 features | svc_type_norm, gate_idx_norm, age_norm, flight_slot_norm, is_active |
| [265] | pending queue | `n_pending / MAX_TASKS` |
...
**same fleet** (FT×2, BT×2, PB×2) at **t=0**.  `_DemoAirportEnv.reset()`
