...
[161..188]  vehicle slots (MAX_VEHICLES=7, VEH_FEATURES=4 each)
...
[189..268]  pending-task slots (MAX_TASKS=16, TASK_FEATURES=5 each)
...
[269]  n_pending_norm              len(pending_tasks) / MAX_TASKS  ∈ [0, 1]
Total: OBS_DIM = 270
...
MAX_VEHICLES   = 7     # fixed fleet (FT×2, BT×3, PB×2)
